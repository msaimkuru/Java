...
class A0{
	...
	public String ii = "ii: initialized in A0";			// ii is inherited by subclass A1 and A2
	public static String si = "si: initialized in A0";	// si is inherited by subclass A1 and A2
	
	public String ij = "ij: initialized in A0"; 			// ij is inherited by A2, is not inherited by subclass A1, it 's hidden by subclass A1
	public static String sj = "sj: initialized in A0";	// sj is inherited by A2, is not inherited by subclass A1, it 's hidden by subclass A1
}


public class A1 extends A0 {
	/*
	 *  We inherit only ii and si from A0.
	 *  We don't inherit ij and sj from A0, we hide them in this subclass.
	...
	public void printVars() {
		// ii and si are inherited from A0
		...
		// ij and sj are not inherited from A0, they are hidden in this subclass
		...
		System.out.println("(A0)this.si-->" + ((A0) this).si);
		System.out.println("(A1)this.si-->" + ((A1) this).si);
		
		System.out.println();
		
		System.out.println("(A0)this.sj-->" + ((A0) this).sj);
...
class A2 extends A0{
	// We inherit ii, si, ij and sj from A0 which means we don't hide them,
	...
	public void printVars() {
		// ii, si, ij and sj is inherited from A0.

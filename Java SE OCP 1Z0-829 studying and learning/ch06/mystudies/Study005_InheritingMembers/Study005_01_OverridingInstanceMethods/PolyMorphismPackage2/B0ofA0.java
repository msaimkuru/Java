...
public class B0ofA0 extends A0{
	...
	public static void main(String[] args) {
		...
		a0.setProtectedInstanceString1(" sets..");
         ...
         error: setProtectedInstanceString1(String) has protected access in A0
		 a0.setProtectedInstanceString1(" sets..");
		   ^
		*/
		
		/*
		 * Reason: The method getProtectedInstanceString1() from the type A0 is not visible
		
		System.out.println(a0.getProtectedInstanceString1());
         
         error: getProtectedInstanceString1() has protected access in A0
		 System.out.println(a0.getProtectedInstanceString1());
		                      ^
         */

...
public class A1 extends A0 {
    ...
    error: getRandom() in A1 cannot override getRandom() in ClassA0
	private static int getRandom() {
	                   ^
	...
	*/
    ...
    error: dummyMethod2() in A1 cannot override dummyMethod2() in ClassA0
	public static void dummyMethod2() throws IOException{}
	                   ^
    overridden method does not throw IOException
	*/
	...
	---------------------------------------------------------------	
    error: dummyMethod5() in A1 cannot hide dummyMethod5() in ClassA0
	public static CharSequence dummyMethod5() { return null;}
	                           ^
	...
	*/
	...
	--------------------------------------------------------------
	error: dummyMethod5() in A1 cannot override dummyMethod5() in ClassA0
	public String dummyMethod5() { return null;}	
	              ^
	...
	*/
	public static void printRandoms() {
		...
		System.out.println("ClassA0.getRandom()-->" + A0.getRandom());
	}

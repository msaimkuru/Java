...
public class A1 extends A0{
	...
	public static void main(String[] args) {
		...
		/* 
		 * Instance method getB1() in parent class A0 is overridden in child class A1.
		 * So, even o0 has a A0 reference type, as it references to a child class
		...
		/* 
		 * Instance method getB2() in parent class A0 is overridden in child class A1.
		 * So, even o0 has a A0 reference type, as it references to a child class
		 ...
		 * class A0. So in child class A1 getB3() method returns the value of inherited 
		 * but hidden variable b3 of parent class A0.
		 */

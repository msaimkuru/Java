...
public class A1 extends A0{
	...
	DOES NOT COMPILE:
	-----------------
    error: protectedFinalMethod1() in A1 cannot override protectedFinalMethod1() in A0
    ...
    */
	...
	DOES NOT COMPILE:
	-----------------
    error: protectedFinalStaticMethod1() in A1 cannot override protectedFinalStaticMethod1() in A0
	protected final static void protectedFinalStaticMethod1() {}	
	                            ^

 ...
 * javac org/curlybrace/oopj/ocp1z0_829/ch06/mystudies/Study004_InitializingObjects/Study004_02_InitializingFinalInstanceVariables/ClassA0.java
 * curlybrace@saim-MacBook-Pro src % 
...
public class A0 {
	...
	/*
	public ClassA0() {	// 2 LINES DON'T COMPILE
	...
	*/
	...
	/*	
	public ClassA0() { 	// 1 LINE DOESN'T COMPILE
		this(null);
		this.volume = 2;		//DOES NOT COMPILE : error: variable volume might already have been assigned

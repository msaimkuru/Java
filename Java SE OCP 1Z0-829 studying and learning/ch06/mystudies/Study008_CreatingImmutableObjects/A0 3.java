...
public final class A0 {
	...
	public A0(ArrayList<String> favoriteTeams) {
		if(favoriteTeams == null || favoriteTeams.size() == 0) 
			throw new RuntimeException("favoriteTeams required!");
		this.favoriteTeams = favoriteTeams; // This makes ClassA0 not-immutable (that is, mutable)
		//this.favoriteTeams = new ArrayList<String>(favoriteTeams);
	}
	
	public List<String> getFavoriteTeams(){
		return this.favoriteTeams;	// This makes ClassA0 not-immutable (that is, mutable)
	}
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * this means o1 changes. So ClassA0 is not immutable (that is, mutable)
		 */

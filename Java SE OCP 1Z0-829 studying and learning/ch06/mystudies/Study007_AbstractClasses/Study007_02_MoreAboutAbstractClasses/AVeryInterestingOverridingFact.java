 ...
 * curlybrace@saim-MacBook-Pro src % 
 * java org.curlybrace.oopj.ocp1z0_829.ch06.mystudies.Study007_AbstractClasses.Study007_02_MoreAboutAbstractClasses.AVeryInterestingOverridingFact
 */
...
abstract class AbstractParentOfAVeryInterestingOverridingFact{
	...
	public String getX() {
		return "X-of-Parent, " + this.saySomething();
	}

	public String getY() {
		return "Y-of-Parent, " + this.saySomething();
	}
	
	public AbstractParentOfAVeryInterestingOverridingFact() {
		System.out.println(saySomething());		// Strange-1) Does this line compile? Answer:Yes
		System.out.println(this.getX());		// Strange-2) This line runs the overridden getX() method in the child class.
		System.out.println(this.getY());		// Strange-3) This line runs the inherited parent class getY() method.
	}
}

public class AVeryInterestingOverridingFact extends AbstractParentOfAVeryInterestingOverridingFact{
	@Override
	...
	public static void main(String[] args) {
		new AVeryInterestingOverridingFact();	// prints "yummy!"
	}
}
...
abstract class A0$ {
	...
	A0$(){
		...
		----------------------------------------------------------------------""");
		abstractMethodOfA0$("abstractMethodOfA0$() called from constructor ClassA0$() runs "); //??? how possible it calls the child method from here???
		//
		instanceMethodOfA0$();
		//
		System.out.println("""
...
public class ClassA0 extends A0${
	...
	public static void main(String[] args) {
		...
		/*
		   ...
		   error: ClassA0$ is abstract; cannot be instantiated
		   var o1 = new ClassA0$();
		            ^
           1 error
         */
